...
If you need Tailwind support, checkout this awesome boilerplate created by [Jorgeuos](https://github.com/jorgeuos/chrome-extension-webpack).
Docs added here: [./docs/Tweaks-To-Make-It-Work.md](./docs/Tweaks-To-Make-It-Work.md).
